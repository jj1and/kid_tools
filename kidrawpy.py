...
class Taudraw():
    ...
    def plot_histogram(self, **kwargs):
        ...
        ax_area.tick_params(direction='in')
        ...
        ax_tvsAmp.tick_params(direction='in')
    ...
    def plot_stats(self, **kwargs):
        ...
        ax_svsr.tick_params(direction='in')
        ...
        ax_svt.tick_params(direction='in')
        ...
        ax_srvt.tick_params(direction='in')
        ...
        ax_svA.tick_params(direction='in')
        ...
        ax_srvA.tick_params(direction='in')
    ...
    def plot_tod_histogram(self, **kwargs):
        ...
        ax_sn_amp.tick_params(direction='in')
        ...
        ax_sum_sig_area.tick_params(direction='in')
        ...
        ax_sum_nos_area.tick_params(direction='in')
        ...
        ax_sum_area.tick_params(direction='in')
