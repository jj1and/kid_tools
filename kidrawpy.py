...
class Taudraw():
    ...
    def plot_histogram(self, **kwargs):
        ...
        ax_tau.tick_params(direction='in', which='minor', zorder=5.5)
        ...
        ax_amp.tick_params(direction='in', which='minor', zorder=5.5)
        ...
        ax_area.tick_params(direction='in', which='minor', zorder=5.5)
        ...
        ax_tvsAmp.tick_params(direction='in', which='minor', zorder=5.5)
    ...
    def plot_stats(self, **kwargs):
        ...
        ax_svsr.tick_params(direction='in', which='minor', zorder=5.5)
        ...
        ax_svt.tick_params(direction='in', which='minor', zorder=5.5)
        ...
        ax_srvt.tick_params(direction='in', which='minor', zorder=5.5)
        ...
        ax_svA.tick_params(direction='in', which='minor', zorder=5.5)
        ...
        ax_srvA.tick_params(direction='in', which='minor', zorder=5.5)
    ...
    def plot_tod_histogram(self, **kwargs):
        ...
        ax_sn_amp.tick_params(direction='in', which='minor', zorder=5.5)
