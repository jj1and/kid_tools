...
class Taudraw():
    ...
    def plot_histogram(self, **kwargs):
        ...
        ax_tau.xaxis.set_minor_locator(AutoMinorLocator(5))
        ax_tau.tick_params(direction='in', zorder=5.5)
        ax_tau.tick_params(direction='in', which='minor')
        ...
        ax_amp.xaxis.set_minor_locator(AutoMinorLocator(5))
        ax_amp.tick_params(direction='in', zorder=5.5)
        ax_amp.tick_params(direction='in', which='minor')
        ...
        ax_area.xaxis.set_minor_locator(AutoMinorLocator(5))
        ax_area.tick_params(direction='in', zorder=5.5)
        ax_area.tick_params(direction='in', which='minor')
        ...
        ax_tvsAmp.xaxis.set_minor_locator(AutoMinorLocator(5))
        ax_tvsAmp.yaxis.set_minor_locator(AutoMinorLocator(5))
        ax_tvsAmp.tick_params(direction='in', zorder=5.5)
        ax_tvsAmp.tick_params(direction='in', which='minor')
    ...
    def plot_stats(self, **kwargs):
        ...
        ax_svsr.xaxis.set_minor_locator(AutoMinorLocator(5))
        ax_svsr.yaxis.set_minor_locator(AutoMinorLocator(5))
        ax_svsr.tick_params(direction='in', zorder=5.5)
        ax_svsr.tick_params(direction='in', which='minor')
        ...
        ax_svt.xaxis.set_minor_locator(AutoMinorLocator(5))
        ax_svt.yaxis.set_minor_locator(AutoMinorLocator(5))
        ax_svt.tick_params(direction='in', zorder=5.5)
        ax_svt.tick_params(direction='in', which='minor')
        ...
        ax_srvt.xaxis.set_minor_locator(AutoMinorLocator(5))
        ax_srvt.yaxis.set_minor_locator(AutoMinorLocator(5))
        ax_srvt.tick_params(direction='in', zorder=5.5)
        ax_srvt.tick_params(direction='in', which='minor')
        ...
        ax_svA.xaxis.set_minor_locator(AutoMinorLocator(5))
        ax_svA.yaxis.set_minor_locator(AutoMinorLocator(5))
        ax_svA.tick_params(direction='in', zorder=5.5)
        ax_svA.tick_params(direction='in', which='minor')
        ...
        ax_srvA.xaxis.set_minor_locator(AutoMinorLocator(5))
        ax_srvA.yaxis.set_minor_locator(AutoMinorLocator(5))
        ax_srvA.tick_params(direction='in', zorder=5.5)
        ax_srvA.tick_params(direction='in', which='minor')
    ...
    def plot_tod_histogram(self, **kwargs):
        ...
        ax_sn_amp.xaxis.set_minor_locator(AutoMinorLocator(5))
        # ax_sn_amp.yaxis.set_minor_locator(AutoMinorLocator(5))
        ax_sn_amp.tick_params(direction='in', zorder=5.5)
        ax_sn_amp.tick_params(direction='in', which='minor')
        ...
        ax_sum_sig_area.xaxis.set_minor_locator(AutoMinorLocator(5))
        # ax_sum_sig_area.yaxis.set_minor_locator(AutoMinorLocator(5))
        ax_sum_sig_area.tick_params(direction='in', zorder=5.5)
        ax_sum_sig_area.tick_params(direction='in', which='minor')
        ...
        ax_sum_nos_area.xaxis.set_minor_locator(AutoMinorLocator(5))
        # ax_sum_nos_area.yaxis.set_minor_locator(AutoMinorLocator(5))
        ax_sum_nos_area.tick_params(direction='in', zorder=5.5)
        ax_sum_nos_area.tick_params(direction='in', which='minor')
        ...
        ax_sum_area.xaxis.set_minor_locator(AutoMinorLocator(5))
        # ax_sum_area.yaxis.set_minor_locator(AutoMinorLocator(5))
        ax_sum_area.tick_params(direction='in', zorder=5.5)
        ax_sum_area.tick_params(direction='in', which='minor')
